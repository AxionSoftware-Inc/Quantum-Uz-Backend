...
def update_nginx(host, user, password):
    try:
        ...
        # Consolidate Nginx config for Quantum-Uz
        nginx_config = """
server {
    listen 80;
    ...
    location /static/ {
        alias /root/var/www/Quantum-Uz-Backend/static/;
    }

    location /media/ {
        alias /root/var/www/Quantum-Uz-Backend/media/;
    }
}
"""
        # Write to a temp file and then move it to sites-available/default
        # Note: We use sudo if needed, but we are root here.
